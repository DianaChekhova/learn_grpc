...
func (x *RegisterRequest) Reset() {
	*x = RegisterRequest{}
	mi := &file_grpc_learn_proto_msgTypes[0]
...
func (*RegisterRequest) Descriptor() ([]byte, []int) {
	return file_grpc_learn_proto_rawDescGZIP(), []int{0}
}
...
func (x *RegisterResponse) Reset() {
	*x = RegisterResponse{}
	mi := &file_grpc_learn_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RegisterResponse) Descriptor() ([]byte, []int) {
	return file_grpc_learn_proto_rawDescGZIP(), []int{1}
}
...
func (x *LoginRequest) Reset() {
	*x = LoginRequest{}
	mi := &file_grpc_learn_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*LoginRequest) Descriptor() ([]byte, []int) {
	return file_grpc_learn_proto_rawDescGZIP(), []int{2}
}
...
func (x *LoginResponse) Reset() {
	*x = LoginResponse{}
	mi := &file_grpc_learn_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*LoginResponse) Descriptor() ([]byte, []int) {
	return file_grpc_learn_proto_rawDescGZIP(), []int{3}
}
...
var File_grpc_learn_proto protoreflect.FileDescriptor

var file_grpc_learn_proto_rawDesc = string([]byte{
	0x0a, 0x10, 0x67, 0x72, 0x70, 0x63, 0x5f, 0x6c, 0x65, 0x61, 0x72, 0x6e, 0x2e, 0x70, 0x72, 0x6f,
	...
	0x2b, 0x5a, 0x29, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x44, 0x69,
	0x61, 0x6e, 0x61, 0x43, 0x68, 0x65, 0x6b, 0x68, 0x6f, 0x76, 0x61, 0x2f, 0x7a, 0x6c, 0x67, 0x31,
	0x2f, 0x67, 0x65, 0x6e, 0x2f, 0x67, 0x6f, 0x2f, 0x7a, 0x6c, 0x67, 0x31, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
})

var (
	file_grpc_learn_proto_rawDescOnce sync.Once
	file_grpc_learn_proto_rawDescData []byte
)

func file_grpc_learn_proto_rawDescGZIP() []byte {
	file_grpc_learn_proto_rawDescOnce.Do(func() {
		file_grpc_learn_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_grpc_learn_proto_rawDesc), len(file_grpc_learn_proto_rawDesc)))
	})
	return file_grpc_learn_proto_rawDescData
}

var file_grpc_learn_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_grpc_learn_proto_goTypes = []any{
	(*RegisterRequest)(nil),  // 0: auth.RegisterRequest
	(*RegisterResponse)(nil), // 1: auth.RegisterResponse
	(*LoginRequest)(nil),     // 2: auth.LoginRequest
	(*LoginResponse)(nil),    // 3: auth.LoginResponse
}
var file_grpc_learn_proto_depIdxs = []int32{
...
func init() { file_grpc_learn_proto_init() }
func file_grpc_learn_proto_init() {
	if File_grpc_learn_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_grpc_learn_proto_rawDesc), len(file_grpc_learn_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_grpc_learn_proto_goTypes,
		DependencyIndexes: file_grpc_learn_proto_depIdxs,
		MessageInfos:      file_grpc_learn_proto_msgTypes,
	}.Build()
	File_grpc_learn_proto = out.File
	file_grpc_learn_proto_goTypes = nil
	file_grpc_learn_proto_depIdxs = nil
}
